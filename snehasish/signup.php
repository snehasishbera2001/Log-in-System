...
if(isset($_POST['submit']))
{
    ...
    $sql=mysqli_query($con,"select id from userspanel where email='$email'");
    $row=mysqli_num_rows($sql);
    if($row>0)
    {
        echo "<script>alert('Email id already exist with another account. Please try with other email id');</script>";
    } else{
        $msg=mysqli_query($con,"insert into userspanel(fname,lname,email,praddr,peaddr,password,contactno,gender,nationality) values('$fname','$lname','$email','$praddr','$peaddr','$password','$contact','$gender','$nationality')");
                                ...
                                <div class="card-body">
                                    <form method="post" name="signup" onSubmit="return checkpass();">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="praddr" name="praddr" type="praddr"
                                                    placeholder="Enter your present address" required />
                                                <label for="inputAddress">Present address</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="peaddr" name="peaddr" type="peaddr"
                                                    placeholder="Enter your permannent address" required />
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="nationality" name="nationality"
                                                        type="text" placeholder="Enter your nationalty" required />
